...
--
-- Host: localhost    Database: innovapes
-- ------------------------------------------------------
...
CREATE TABLE `user_availabilities` (
  ...
  KEY `userID` (`userID`),
  CONSTRAINT `user_availabilities_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`)
...
INSERT INTO `user_availabilities` VALUES (1,1612510200000,1612513800000),(1,1612517400000,1612521000000);
...
-- Dump completed on 2021-02-06 14:02:56
